...
<div class="card">
    <h5 class="card-header font-weight-light">
        <a href="${pageContext.request.contextPath}/studednt" style="text-decoration: none">
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-info">
                                <a style="color: white; text-decoration: none"
                                   href="/pstudent?action=editGet&id=${students.getId_students()}"><i
                        ...
                        <td>
                            <button type="button" class="btn btn-danger">
                                <a style="color: white; text-decoration: none"
                                   href="/students?action=delete&id=${students.getId_students()}"><i
